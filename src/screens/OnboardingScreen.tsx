            ...
            <FlatList
              ...
              renderItem={({ item }) => (
                <View style={styles.doubtChip}>
                  <Text style={styles.doubtChipText}>{item}</Text>
                </View>
              )}
            />
...
const styles = StyleSheet.create({
  ...
  milestoneMark: {
    ...
    width: 2, height: 11, backgroundColor: Colors.border, borderRadius: 1, marginLeft: -1,
  },
  ...
  genreEyebrow: {
    ...
    fontWeight: Typography.medium, letterSpacing: 2, marginTop: 8,
  },
  genreHeading: {
    color: Colors.text, fontSize: Typography.h1,
    fontWeight: Typography.bold, marginTop: 8, marginBottom: 4,
  },
  ...
  genreChip: {
    ...
    backgroundColor: Colors.s1, borderRadius: 20,
  ...
  doubtChips: { gap: 6 },
  doubtChip: {
    backgroundColor: Colors.accentFaint, borderRadius: 6,
